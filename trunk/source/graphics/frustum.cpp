...
void CDebug::AddDebugLine(Vector3d vPoint1, Vector3d vPoint2)
{
...
void CDebug::AddDebugBox(Vector3d vCenter, float width, float height, float depth)
{
	...
	Vector3d vTopLeftFront( vCenter.x - width, vCenter.y + height, vCenter.z + depth);
	Vector3d vTopLeftBack(  vCenter.x - width, vCenter.y + height, vCenter.z - depth);
	Vector3d vTopRightBack( vCenter.x + width, vCenter.y + height, vCenter.z - depth);
	Vector3d vTopRightFront(vCenter.x + width, vCenter.y + height, vCenter.z + depth);

	Vector3d vBottom_LeftFront( vCenter.x - width, vCenter.y - height, vCenter.z + depth);
	Vector3d vBottom_LeftBack(  vCenter.x - width, vCenter.y - height, vCenter.z - depth);
	Vector3d vBottomRightBack( vCenter.x + width, vCenter.y - height, vCenter.z - depth);
	Vector3d vBottomRightFront(vCenter.x + width, vCenter.y - height, vCenter.z + depth);
